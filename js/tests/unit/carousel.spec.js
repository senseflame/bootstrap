...
describe('Carousel', () => {
  ...
  describe('constructor', () => {
    ...
    it('should not prevent keydown if key is not ARROW_LEFT or ARROW_RIGHT', done => {
      ...
      carouselEl.addEventListener('keydown', ({ defaultPrevented }) => {
        expect(carousel._keydown).toHaveBeenCalled()
    ...
    it('should wrap around from end to start when wrap option is true', done => {
      ...
      carouselEl.addEventListener('slid.bs.carousel', ({ from }) => {
    ...
    it('should allow swiperight and call _slide (prev) with pointer events', done => {
      ...
      carouselEl.addEventListener('slid.bs.carousel', ({ direction }) => {
  ...
  describe('next', () => {
    ...
    it('should fire slide event with: direction, relatedTarget, from and to', done => {
      ...
      const onSlide = ({ direction, relatedTarget, from, to }) => {
        expect(direction).toEqual('left')
        expect(relatedTarget.classList.contains('carousel-item')).toEqual(true)
    ...
    it('should fire slid event with: direction, relatedTarget, from and to', done => {
      ...
      const onSlid = ({ direction, relatedTarget, from, to }) => {
        expect(direction).toEqual('left')
        expect(relatedTarget.classList.contains('carousel-item')).toEqual(true)
        expect(from).toEqual(0)
        expect(to).toEqual(1)
